...
# encoding: utf-8
  def get_traffic
    ...
    traffic["level"] = case traffic["level"]
        when "0" then "0 " +I18n.t('traffic.zerofive')
        when "1" then "1 " +I18n.t('traffic.one')
        when "2" then "2 " +I18n.t('traffic.other')
        when "3" then "3 " +I18n.t('traffic.other')
        when "4" then "4 " +I18n.t('traffic.other')
        when "5" then "5 " +I18n.t('traffic.zerofive')
